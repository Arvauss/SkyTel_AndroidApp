...
import com.example.skytel_mobileapp.Adapters.FAQAdapter;
...
public class FAQ extends AppCompatActivity {
    ...
    ArrayList<FAQModel> arrFaqs = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbRef = FirebaseDatabase.getInstance().getReference().child("WebFAQ's");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot snap: snapshot.getChildren()) {
                    arrFaqs.add(snap.getValue(FAQModel.class));
                    Log.d("123456", "FAQ added: " + snap.getValue(FAQModel.class).getId());
                }
    ...
    public void InitRecycler(){
        rvFaq = findViewById(R.id.faq_rv);
        FAQAdapter adap = new FAQAdapter(this, arrFaqs);
        LinearLayoutManager llm = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);

        rvFaq.setAdapter(adap);
